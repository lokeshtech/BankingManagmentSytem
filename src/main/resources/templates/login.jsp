			...
			<div class="col-md-6 col-md-offset-3">
				...
				<form th:action="@{/login}" method="POST" class="form-signin">
					<br /> <input type="text" id="user_name" name="user_name"
						placeholder="Enter User Name" class="form-control" data-rule="required"
						data-msg="Please enter User Name" /> <br />
					<div class="validate"></div>
					 <input type="password" placeholder="Enter Password"
						id="password" name="password" class="form-control"
						data-rule="required" data-msg="Please enter Password" /> <br />
					<div class="validate"></div>
					<br />
					<div align="center" th:if="${param.error}">
						<p style="font-size: 20; color: #FF1C19;">User Name or
